...
impl Session  {
    pub(crate) fn connect<A: net::ToSocketAddrs>(addr: A) -> io::Result<Self> {
        ...
        sess.handshake().map_err(|e| io::Error::new(io::ErrorKind::Other, e))?;

        sess.userauth_agent("ec2-user").map_err(|e| io::Error::new(io::ErrorKind::Other, e))?;
